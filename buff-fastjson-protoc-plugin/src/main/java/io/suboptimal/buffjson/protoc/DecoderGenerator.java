 ...
 * generated decoder implements {@code GeneratedDecoder<T>} and uses typed
 * setters on the Builder directly, avoiding reflection and runtime type
 * dispatch.
 */
final class DecoderGenerator {
	...
	static String generate(Descriptor msgDesc, String javaPackage, String decoderSimpleName, String messageClassName,
		...
		sb.append("import io.suboptimal.buffjson.GeneratedDecoder;\n\n");
		sb.append("public final class ").append(decoderSimpleName);
		sb.append(" implements GeneratedDecoder<").append(messageClassName).append("> {\n\n");
